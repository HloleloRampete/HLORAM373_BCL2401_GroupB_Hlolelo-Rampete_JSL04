...
// display whether the user prefers a "Regular" or "Sugar-free" variety. If the preference is not set, default to "Regular".

let userPreference = 'Sugar-free'; // Possible values: 'Regular', 'Sugar-free', or undefined

// Determine the user's preferred Monster Energy flavor, defaulting to 'Regular' if not explicitly set
// Display the variety based on user's preference
console.log(`${userPreference === 'Sugar-free' ? 'Sugar-free' : 'Regular'}`);

// #### Challenge 2: Stock Check
// You have a variable that tracks the number of Monster Energy cans left in the fridge. 
// Use a ternary operator to display "Time to restock!" if the number is less than 5, or "We're stocked!" if the number is 5 or more.

let cansLeft = 4; // Number of cans

/* Check the stock status against the number of cans left
 Display the stocking status based on the remaining cans on stock. */
...
// If the heart rate is below 100 bpm, display "Boost needed!", otherwise, print "Energy levels are high!".

let heartRate = 94; // Current heart rate in bpm

/* Check energy levels based on the current heart rate
 Display an appropriate advise based on the current heart rate */
...
let currentTemp = 3; // Current temperature in °C

/* Examine the temperature suitability for the Monster Energy drink
 Display a particular suggestion based on the temperature */
